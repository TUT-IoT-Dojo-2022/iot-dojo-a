...
def web_view():
  ...
  return render_template("index.html", data=[height,shoulder,waist,legs,height,raw_kata_a,raw_kata_b,str(int(legs)-INSEAM_FIX),waist_a,waist_b,waist_c,waist_d,CLOTHES_FIX])
